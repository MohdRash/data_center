...
function App() {
  ...
  }, [searchTerm, selectedLocation, selectedTier]);

  const locations = [...new Set(dataCenters.map(dc => dc.location))];
  const tiers = [...new Set(dataCenters.map(dc => dc.tier))];
      ...
      {selectedDataCenter ? (
        ...
        <>
          ...
          <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            {viewMode === 'analytics' ? (
              <AdvancedAnalytics dataCenters={dataCenters} />
            ) : viewMode === 'grid' ? (
